...
const Footer: React.FC = () => {
  ...
  const socialMedia = [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/officialariesleo/?hl=en",
      IconComponent: InstagramIcon,
    },
    {
      name: "Facebook",
      href: "https://www.facebook.com/ariesleoshop",
          ...
          {/* <div className="lg:col-span-1">
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <input
                ...
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-rose focus:border-transparent"
                disabled={newsletterStatus === 'loading'}
              />
              <button
                type="submit"
                disabled={newsletterStatus === 'loading'}
                className="w-full px-4 py-2 bg-accent-rose text-white rounded-md hover:bg-accent-mauve transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
