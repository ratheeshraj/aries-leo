  ...
  const values = [
    {
      ...
      description:
        "Every piece is designed specifically for women's bodies, ensuring flattering fits and comfortable wear all day long.",
    },
    {
      icon: <GlobeAltIcon className="w-8 h-8" />,
      title: "Sustainable Fashion",
      description:
        "We're committed to sustainable practices, from eco-friendly materials to ethical manufacturing processes.",
    },
    {
      icon: <UserGroupIcon className="w-8 h-8" />,
      title: "Empowering Women",
      description:
        "We believe in empowering women through fashion that makes them feel confident, comfortable, and authentically themselves.",
    },
    {
      icon: <CheckCircleIcon className="w-8 h-8" />,
      title: "Inclusive Sizing",
      description:
        "We create bottoms for every woman, offering inclusive sizing and styles that celebrate all body types.",
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-accent-light to-accent-medium overflow-hidden">
        ...
        <div className="relative container-responsive">
          ...
          >
            <h1 className="text-fluid-3xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6">Our Story</h1>
            <p className="text-fluid-base text-gray-700 leading-relaxed">
              At Aries Leo, we believe that the perfect pair of bottoms should empower every woman. That's why we've
              dedicated ourselves to creating premium, comfortable, and stylish women's bottoms that celebrate your
              unique style and confidence.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-fluid-sm text-gray-600 mb-3 sm:mb-4 md:mb-6 leading-relaxed">
                Founded in 2020, Aries Leo was born from a simple observation: most women's bottoms compromise on either
                comfort, style, or functionality. We set out to create bottoms that excel in all three areas,
                specifically designed for women.
              </p>
              <p className="text-fluid-sm text-gray-600 mb-4 sm:mb-6 md:mb-8 leading-relaxed">
                Our philosophy "Cotton • Comfort • Confidence" isn't just marketing—it's our commitment. Every pair is
                crafted from premium cotton for ultimate comfort, features thoughtfully designed details for
                functionality, and comes in styles that let your confidence shine through.
              </p>
                ...
                >
                  ...
                  >
                    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg border-l-4 md:border-l-0 border-accent-rose">
                      <div className="text-accent-rose font-bold text-base sm:text-lg mb-2">{item.year}</div>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-accent-rose">
        <div className="container-responsive text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-fluid-2xl font-bold text-white mb-3 sm:mb-4">Ready to Feel Empowered?</h2>
