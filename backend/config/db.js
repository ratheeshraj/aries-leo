...
const connectDB = async () => {
  ...
  try {
    ...
    const bbifyUri = "mongodb+srv://super-admin:*DB56nC%3Ecgg7%3EGGu@bbify.ge61eao.mongodb.net/bbify?retryWrites=true&w=majority";
    bbifyConn = await mongoose.createConnection(bbifyUri, {
      useNewUrlParser: true,
      useUnifiedTopology: true,
    }).asPromise();
...
const initializeConnections = async () => {
    ...
    bbifyInventoryModel = connections.bbifyConn.model('inventories', inventorySchema);
    bbifyProductModel = connections.bbifyConn.model('products', productSchema);
    bbifyCategoryModel = connections.bbifyConn.model('categories', categorySchema);
};
...
module.exports = { initializeConnections, getBbifyProductModel, getBbifyInventoryModel, getBbifyCategoryModel }; 